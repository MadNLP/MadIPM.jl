...
batch_spmv!(out::AbstractMatrix{T}, op::BatchSparseOperator, B::AbstractMatrix,
  ...
  _batch_spmv_impl!(out, op, B, alpha, beta, val_offset)
...
LinearAlgebra.mul!(Y::AbstractMatrix{T}, op::BatchSparseOperator, X::AbstractMatrix{T}) where {T} =
  batch_spmv!(Y, op, X)

function _batch_spmv_impl!(out::AbstractMatrix{T}, op::HostBatchSparseOperator, B::AbstractMatrix,
                           alpha::T, beta::T, val_offset::Int) where {T}
